...
namespace App\Agent\Infrastructure\Fixtures;

use App\Agent\Domain\Entity\Agent;
use App\Node\Domain\Entity\Node;
use App\Node\Infrastructure\Fixtures\NodeFixtures;
 ...
 * the frontend both states to handle. No {@see \App\Agent\Domain\Entity\AgentCredential} is
